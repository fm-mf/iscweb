...
class CropAvatar {
    ...
    private $type;
    private $extension;
    private $srcDir = 'static/upload';
    private $dstDir = 'static/avatar';
    private $msg;
    ...
    private function setFile($file) {
        ...
        if ($errorCode === UPLOAD_ERR_OK) {
            ...
            if ($type) {
                ...
                $src = $dir . '/' . $this -> getName() . $extension;
    ...
    private function setDst() {
        ...
        $this -> dst = $dir . '/' . $this -> getName()  . $this -> extension;
    }
...
$crop = new CropAvatar($_POST['avatar_src'], $_POST['avatar_data'], $_FILES['avatar_file'], $_POST['id']);
$response = array(
    'state'  => 200,
    'message' => $crop -> getMsg(),
