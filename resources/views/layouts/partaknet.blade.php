        ...
        <div class="row">
            <div class="collapse navbar-collapse navbar-main-collapse col-sm-9">
                <ul class="nav navbar-nav admin-nav">
                    <li><a href="Default:" class="{{ $user->hasRole('admin')? 'active' : 'disabled' }}">Dashboard</a></li>
                    <li><a href="https://isc.cvut.cz/iscproisc"class="{{ $user->hasRole('admin')? 'active' : 'disabled' }}">ISC pro ISC</a></li>
                    <li><a href="Feedback:" class="{{ $user->hasRole('admin')? 'active' : 'disabled' }}">Feedbacky</a></li>
                    <li><a href="{{ url('partak/trips') }}" class="{{ $user->hasRole('admin')? 'active' : 'disabled' }}">Trips</a></li>
                    <li><a href="{{ url('partak/buddy') }}" class="{{ $user->hasRole('admin')? 'active' : 'disabled' }}">Buddy Program</a></li>
                    <li><a href="" ></a></li>
                </ul>
            </div>
        </div>
