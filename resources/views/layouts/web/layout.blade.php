        ...
        <div class="row">
            <div class="col-sm-2">
                ...
                <ul class="list-unstyled">
                    <li><a href="http://www.integreat.cz" target="_blank"><img src="{{ URL::asset('web/img/integreat_svetle_60x60.png') }}" width="17px"> inteGREAT</a></li>
            ...
            <div class="col-sm-2">
                ...
                <span class="bar"></span>
                <ul class="list-unstyled">
                    <li><a href="https://www.facebook.com/isc.ctu.prague" target="_blank"><img src="{{ URL::asset('web/img/fb.png') }}" width="17px"> Facebook</a></li>
                    <li><a href="https://www.linkedin.com/company/1201189" target="_blank"><img src="{{ URL::asset('web/img/in.png') }}" width="17px"> LinkedIn</a></li>
                    <li><a href="http://www.youtube.com/user/ISCCTUPrague" target="_blank"><img src="{{ URL::asset('web/img/youtube.png') }}" width="17px"> YouTube</a></li>
            ...
            <div class="col-sm-2">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="https://www.isc.cvut.cz/muj-buddy" target="_blank">Buddy Program</a></li>
                </ul>
            </div>
            <div class="col-sm-6">
