...
@section('content')
    <div class="container page">
        <h2 class="text-center">Databáze zahraničních studentů ještě nebyla otevřena. Buddy Program pro {{ $season }} semestr {{ $schoolYear }} bude spuštěn {{ $buddyDbFrom }} v {{ $buddyDbFromTime }}.</h2>
