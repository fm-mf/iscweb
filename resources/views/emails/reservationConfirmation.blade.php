...
<html lang="en">
    ...
    <body>
        ...
        <p>If you can't participate and you didn't already confirm your reservation, please use following link to cancel it: <strong><a href="{{ url("/event/{$event->reservations_hash}/cancel/{$response->hash}") }}">CANCEL</a></strong>. If you've already confirmed your reservation, contact organizers or ISC to let them know you're not coming.</p>
