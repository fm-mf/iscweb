...
@section('subpage')
    ...
    <ol>
        <li>Learn how to do ESN fishing.</li>
...
{{--        <li>Go to Klubovna once a week.</li>--}}
        ...
        <li>Spend every other evening in the ISC HUB bar downstairs in Masarykova</li>
        <li>Try things you would never do home.</li>
        <li>Get a photo of yourself on the Red Couch in the ESN Point!</li>
