...
@section('subpage')
    ...
    <ul>
        ...
        <ul>
            ...
            <li>Costs CZK 500, but is more widely accepted</li>
    ...
    <ul class="list-unstyled">
        ...
        <li><strong>Price: for free</strong>, in  the case of loss, a fee of CZK 250 is charged for a duplicate</li>
    ...
    <ul class="list-unstyled">
        ...
        <li><strong>Price: CZK 500</strong>, in  the case of loss, a fee of CZK 250 is charged for a duplicate</li>
