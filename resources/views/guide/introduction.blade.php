...
@section('subpage')
    ...
    <p><span>Dear international students,</span>
        ...
        useful information concerning all the topics for surviving in the Czech Republic.</p>
    <p>If you need help or advice, ask your Czech Buddy or come to the ISC, and we will try
        ...
        students. All information about International Student Club is available on our website
        <a href="https://www.isc.cvut.cz" target="_blank">www.isc.cvut.cz</a>
        or at our Facebook page ISC CTU in Prague.</p>
    <img src="{{ asset('img/guide/ow-group-photo.jpg') }}" alt="Group photo of international students from Orientation week" title="Group photo of international students from Orientation week"/>
@stop