...
@section('subpage')
    ...
    <h4 id="night">Night transport</h4>
    <ul>
    ...
    <h4 id="ticket-inspection">Ticket inspection</h4>
    ...
    <h3 id="other">Around the Czech Republic</h3>
    ...
    <h4 id="student-discount">Student discount</h4>
    <p>
    ...
    <h4 id="bus-stations">Main bus stations in Prague</h4>
    <ul>
        <li>Florenc</li>
        <li>Černý Most</li>
        <li>Zličín</li>
    ...
    <h4 id="train-stations">Important railway stations in Prague</h4>
    <ul>
