...
Vue.component('ProtectedSubmitButton', ProtectedSubmitButton);
Vue.component('Preregister', PreRegister);
Vue.component('UniqueUrl', UniqueUrlCopy);
Vue.component('ContactsOrder', ContactsOrder);
Vue.component('ShareButton', ShareButton);
Vue.component('BarcodeButton', BarcodeButton);
...
if (formRegister != null) {
    const modalToggleBtn = formRegister.querySelector(
