<template>
    <li class="contact">
        ...
        <ul class="list-unstyled contact-details">
            ...
            <li class="list-item email">Email: <a :href="`mailto:${contact.email}`">{{ contact.email }}</a></li>
            <li v-if="contact.phone" class="list-item">Phone: <a :href="`tel:${contact.phone}`">{{ contact.phoneWithNBSpaces }}</a></li>
        </ul>

        <ul class="list-unstyled">
            <li class="list-item">
                <div class="form-group">
                    <label @click="toggleVisibility">Show on web <input type="checkbox" v-model="visible" /></label>
                </div>
            </li>
            <li class="list-item">
                <div class="form-group">
                    <label @click="togglePhoneVisibility">Show phone # <input type="checkbox" v-model="phoneVisible" /></label>
                </div>
            </li>
        </ul>
...
<script>
    ...
    function deleteContact() {
        const confirmed = confirm(`Delete contact entry for ${this.contact.position}?`);
        if (!confirmed) {
            return;
        }
