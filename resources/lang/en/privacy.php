...
return [
    ...
    'buddy' => [
        ...
        'heading' => 'Privacy policy in Buddy programme',
        'text' => '
            <p>
                In the Buddy programme you can access some personal data about incoming exchange students.
            ...
            <ul>
                <li>it is necessary to prevent unauthorised persons from accessing personal data and the means for their processing, i.e. the Buddy programme system,</li>
                <li>it is necessary to prevent unauthorised reading, creation, copying, transfer, modification or deletion of records containing personal data from the Buddy programme,</li>
                <li>it is necessary to prevent the misuse of records containing personal data from the Buddy programme,</li>
                <li>it is necessary to prevent the use of records containing personal data for purposes other than those used by the Buddy programme.</li>
            </ul>
            <p>
