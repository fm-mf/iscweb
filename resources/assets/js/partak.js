...
Vue.component('contacts-order', require('./components/ContactsOrder.vue').default);
...
function onContactFormSubmit(event) {
    ...
    const canvas = document.getElementById("photo-preview-wrapper").querySelector("canvas");
    if (canvas != null) {
