...
class StatsController extends Controller
{
    public function showStatistics()
    {
        ...
        return view('stats.stats')->with([
            ...
            'studentsWithFilledProfileWithoutBuddy' => ExchangeStudent::byUniqueSemester($currentSemester)->doesntHave('buddy')->count(),
            'countriesStats' => Country::withCount(['exchangeStudent' => function($query) use ($currentSemester) {
                $query->whereHas('semesters', function ($query) use ($currentSemester) {
